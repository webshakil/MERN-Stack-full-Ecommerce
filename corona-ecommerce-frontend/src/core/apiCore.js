...
//shop page filtered product in checkbox and radio button
...
//This list is for home page search. whatever user type in the search bar
//npm i query sting need to be installed here.

export const list = (params) => {
  //params is category id or whatever user search.Later send this params as a query string
